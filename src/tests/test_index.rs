...
fn none_as_index_is_a_squeeze() {
    ...
    assert_hover_expected(&src, &analysis, "z =", "1 A B C D");
}
...
fn ellipsis_type() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "A B C D");
}
...
fn integer_indexing() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "C D");
}
...
fn boolean_indexing() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "0 A B C D");
}
...
fn slice_indexing() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "A/2 B C D");
}
...
fn tensor_indexing() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "C B 2 D");
}
...
fn multi_indices() {
    ...
    let analysis = analyze_source(&src);
    assert_eq!(analysis.diagnostics.len(), 0);
    assert_hover_expected(&src, &analysis, "z =", "2 A C/2");
}
